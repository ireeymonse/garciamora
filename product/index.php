...
<body>
  ...
  while($filas = mysql_fetch_array($consulta)) {
    ...
    $image_url=$filas['image_url'];
      ?>
      <div class="item"><img src="<?php echo $image_url ?>" /><div class="name"><?php echo $name ?></div><span class="line <?php echo $line_id ?>"><?php echo $line ?></span><div class="purchase"><span class="stock"><?php echo $stock ?></span><a href="#" class="price"><?php echo $price ?></a></div></div>
  <?php } ?>
    </section>
  </main>
</body>
